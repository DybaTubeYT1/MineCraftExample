...
import sys
sys.path.insert(0, './assets/models')
import plant
import cactus
class World:
	def __init__(self):
		...
		self.block_types.append(block_type.Block_type(self.texture_manager, "daisy", {"all": "daisy"}, plant))
		self.block_types.append(block_type.Block_type(self.texture_manager, "rose", {"all": "rose"}, plant))
		self.block_types.append(block_type.Block_type(self.texture_manager, "cactus", {"top": "cactus_top", "bottom": "cactus_bottom", "sides": "cactus_side"}, cactus))
		self.block_types.append(block_type.Block_type(self.texture_manager, "dead_bush", {"all": "dead_bush"}, plant))
